...
export default function AddManualTaskDialog({ open, onOpenChange, onSubmit, employees }) {
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label htmlFor="required" className="cursor-pointer">Required for onboarding completion</Label>
          </div>
        </div>
        <DialogFooter>
